...
imgtoico - A quick conversion tool to convert generic image formats into .ico. Simply drag your image onto the bat (the .bat must be in the same dir as the script) and it will create the .ico.
